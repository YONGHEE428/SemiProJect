...
<body>
	...
	<div class="recently-viewed-remote">
		<button class="remote-btn" title="위로"
		...
		<button class="remote-btn" title="장바구니" id="mycart"
			onclick="location.href='index.jsp?main=cart/cartform.jsp'">
		...
		<button onclick="location.href='http://pf.kakao.com/_XsGSn'"
			...
			<img alt="" src="SemiImg/kakao.png"
				style="width: 135%; height: 110%; border-radius: 100%;">
		</button>
		<!--window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' });
	      document.body.scrollHeight 는 문서 전체 높이(스크롤 가능한 최대 높이) 페이지 맨 아래로 부드럽게 이동-->
		<button class="remote-btn" title="아래로"
